      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {userShops.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <h3 className="text-xl text-gray-900 mb-2">Aucune boutique pour le moment</h3>
              ...
              <Card key={shop.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="text-xl text-gray-900 mb-1">{shop.name}</h3>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" onClick={() => navigate(`/shop/${shop.id}`)}>
