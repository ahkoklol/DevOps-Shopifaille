          ...
          <Card className="p-8">
            ...
            {step === 1 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Choisissez un nom accrocheur qui représente votre marque
                </p>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      onChange={(e) =>
                        setShopData({ ...shopData, domain: e.target.value })}
                    />
            ...
            {step === 3 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Un emoji ou une image pour représenter votre boutique
                </p>
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={shopData.logo}
                    onChange={(e) =>
                      setShopData({ ...shopData, logo: e.target.value })}
                  />
            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Cette couleur sera utilisée pour les boutons et accents
                </p>
                  ...
                  {colors.map((color) => (
                    <button
                      ...
                      style={{
                        ...
                        borderColor: shopData.primaryColor === color
                          ? "#000"
                          : "transparent",
                      }}
                    >
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <Card className="p-12 text-center max-w-md">
            ...
            <p className="text-gray-600">
              Votre boutique est en cours de configuration
            </p>
          </Card>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <Card className="p-12 text-center max-w-md">
          ...
          <p className="text-gray-600 mb-8">
            Votre boutique est prête à être utilisée. Vous pouvez maintenant
            commencer à ajouter vos produits.
          </p>
          ...
          <div className="space-y-3">
            ...
            <Button
              variant="ghost"
              className="w-full"
              onClick={() => navigate("/admin/platform/dashboard")}
            >
