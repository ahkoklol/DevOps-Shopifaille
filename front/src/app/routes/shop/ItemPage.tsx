...
function ItemPage() {
    ...
    const product = foundShop?.featuredProducts.find((prod) => prod.id === productId);
                            ...
                            {[1, 2, 3].map((i) => (
                                <Card key={i} className="p-6">
                                    ...
                                    <p className="text-gray-700">
                                        Excellent produit ! Très satisfaite de mon achat.
                                        La qualité est au rendez-vous et la livraison a été rapide.
                                    </p>
                                </Card>
                            ))}
                        </div>
